...
Lab 10 variant 30
	...
	Описати структуру Truck з полями: model, manufacturer, loadCapacity, route, driverName.

	Завдання 1:
		- вивести вантажівки певного виробника;
		- знайти середню вантажопідйомність вантажівок;
		- вивести вантажівки, модель яких починається на літеру M;

	2. Передбачити можливість вставки, видалення запису з позиції, знищення списку.

	Виконання з використанням двозв'язного списку:
*/
