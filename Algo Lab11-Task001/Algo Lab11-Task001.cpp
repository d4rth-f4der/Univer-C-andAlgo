...
Виконати з використанням односпрямованого списку, використовувати функції користувача

Описати структуру Game з полями: title, genre, developer, platform, rating.

Завдання 1:
	- вивести ігри певного жанру;
	- обчислити середній рейтинг усіх ігор;
	- вивести ігри, назва яких починається на літеру F;

Завдання 2:
	- передбачити можливість вставки в задану позицію, видалення запису з заданої позиції, знищення списку;
*/
